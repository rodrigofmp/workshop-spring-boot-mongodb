...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.rodrigofmp.workshopmongo.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do Workshop de Spring Boot com MongoDB",
				"Esta API é utilizada no workshop de Spring Boot com MongoDB do prof. Nelio Alves", 
				"Versão 1.0",
